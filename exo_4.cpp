...
public:
    ...
    static vecteur3d somme(const vecteur3d &vect1, const vecteur3d &vect2) {
        float x,y,z;
    ...
    static float produit_scalaire(const vecteur3d &v1, const vecteur3d &v2) {
        return v1.getX() * v2.getX() + v1.getY() * v2.getY() + v1.getZ() * v2.getZ();
    }
    ...
    static vecteur3d normax(const vecteur3d v1, vecteur3d v2) {
...
int main() {
    vecteur3d v1(1.5, 2, 3.5), v2(1.3, 2.3, 1);
    vecteur3d &ref_v1 = v1, &ref_v2 = v2;
    vecteur3d v3 = vecteur3d::normax(ref_v1, ref_v2);
